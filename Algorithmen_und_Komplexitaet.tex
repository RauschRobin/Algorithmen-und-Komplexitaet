...
\begin{minipage}[c]{0.3\textwidth}
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\draw[black,very thick](-3.18,-3.5) rectangle (-2.18,-4.5);
			...
			\draw[black,very thick](1.18,-5.5) rectangle (2.18,-6.5);
	...
	\begin{minipage}[c]{0.5\textwidth}
		\begin{center}
			\begin{tikzpicture}[scale=0.6]
				...
				\draw[green, very thick, ->](0.75,-10) to[out=45, in=100] (5.5, -13.5);

				\draw[green,very thick](4,-13.5) rectangle (9,-14.5);
				\draw[green, very thick](5,-13.5) -- (5,-14.5);
				\draw[green, very thick](6,-13.5) -- (6,-14.5);
				\draw[green, very thick](7,-13.5) -- (7,-14.5);
				\draw[green, very thick](8,-13.5) -- (8,-14.5);
				\node at (4.5,-14){9};
				\node at (5.5,-14){8};
				...
				\node[text=red] at (6,-17.5){Heapify};
